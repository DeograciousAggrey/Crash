<template>
  <div class="spoiler">
    ...
    <div ref="body" class="spoiler__body" :style="{ height: bodyHeight }">
      <p class="pb-4">
        <slot name="text"
          >WAIPESA - financial games with the withdrawal of real funds. At the
          moment The site presents the 5 most popular money games. WAIPESA
          registered in the UK and operating in in accordance with all
